export type ConnectionDisconnectReason =
	| 'clientDisconnected'
	| 'forceDisconnected'
	| 'networkDisconnected';
 ...
 */
export interface ConnectionEvent<T extends 'connectionCreated' | 'connectionDestroyed'>
	extends Event<T> {
 ...
 */
export interface SessionEvent<T extends 'sessionConnected' | 'sessionDisconnected'>
	extends Event<T> {
	connections?: Connection[];
	streams?: Stream[];
}
...
export interface StreamEvent<
	T extends 'streamCreated' | 'streamDestroyed' | 'streamPropertyChanged',
> extends Event<T> {
	stream: Stream;
	streams?: Stream[];
}
 ...
 */
export interface StreamPropertyChangedEvent<V = unknown>
	extends StreamEvent<'streamPropertyChanged'> {
 ...
 */
export interface VideoEnabledChangedEvent<T extends 'videoDisabled' | 'videoEnabled'>
	extends Event<T> {
...
export interface EventEmitter<EventHandlers extends {}> {
	 ...
	 * @deprecated Use on
	 */
	addEventListener<T extends keyof EventHandlers & string>(
		type: T,
	 ...
	 * @deprecated Use off
	 */
	removeEventListener<T extends keyof EventHandlers & string>(
		type: T,
		listener: EventHandlers[T],
		context?: any,
	): void;
	...
	on<T extends keyof EventHandlers & string>(
		type: T,
	...
	once<T extends keyof EventHandlers & string>(
		type: T,
